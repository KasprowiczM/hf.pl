  ...
  return (
    <section className="section-shell section-tone-deep reveal reveal-up" id="valuation">
      <div className="section-frame">
        <div className="interactive-card reveal reveal-up overflow-hidden rounded-[2rem] border border-border bg-[linear-gradient(135deg,#13202d_0%,#1b2432_48%,#412a18_100%)] px-6 py-8 text-white sm:px-8 sm:py-10 lg:grid lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:items-center lg:gap-10">
          <div>
          ...
          <div className="mt-8 rounded-[1.8rem] border border-white/10 bg-white/6 px-6 py-7 backdrop-blur-sm lg:mt-0">
            ...
            <a
              ...
              className="action-pill mt-7 w-full bg-white text-text no-underline hover:-translate-y-0.5 hover:bg-[#f5e5d0]"
            >
              {t('val_cta')}
