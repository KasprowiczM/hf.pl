...
<nav
  className="section-frame flex items-center justify-between rounded-full border border-white/18 bg-[rgba(8,10,14,0.86)] px-4 py-3 shadow-[0_24px_60px_rgba(4,8,14,0.42)] backdrop-blur-xl sm:px-5"
  aria-label="Main navigation"
>
          <a href="#hero" className="flex items-center gap-3 no-underline">
            <span className="display-title text-[1.65rem] leading-none tracking-tight text-white">
          ...
          <div className="hidden items-center gap-6 lg:flex">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="flex rounded-full border border-white/16 bg-white/6 p-1" role="group" aria-label={t('language_switch')}>
                <button
                  type="button"
              ...
              <div className="flex rounded-full border border-white/16 bg-white/6 p-1" role="group" aria-label={t('theme_switch')}>
                <button
                  type="button"
                  onClick={cycleTheme}
                  className="rounded-full px-3 py-1.5 text-xs font-semibold uppercase tracking-[0.16em] text-white/62 hover:bg-white/12 hover:text-white"
