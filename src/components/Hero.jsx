  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 pt-32 pb-16 relative overflow-hidden" id="hero">
      <div className="absolute inset-0 z-[-1]" aria-hidden="true">
        <div className="absolute -top-[30%] left-1/2 -translate-x-1/2 w-[800px] h-[800px] rounded-full bg-[radial-gradient(circle,var(--color-primary-dim)_0%,transparent_70%)] opacity-60"></div>
