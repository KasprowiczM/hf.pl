...
function detectInitialLanguage() {
  ...
  if (
    window.location.pathname === ENGLISH_PATH_PREFIX ||
    window.location.pathname.startsWith(`${ENGLISH_PATH_PREFIX}/`)
  ) {
    return 'en';
  }
...
export function persistLanguage(language) {
  ...
  // Single lang writer: Helmet owns document.documentElement.lang
}
